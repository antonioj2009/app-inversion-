...
# Cuadro seguro para introducir la clave correcta
api_key = st.text_input(
    "Introduce tu Gemini API Key (empieza por AIza...):", type="password"
)
...
if st.button("🚀 Escanear Mercado y Generar Ranking"):
    if not api_key:
        st.error(
            "Por favor, introduce una API Key válida de Google AI Studio."
        )
    else:
        with st.spinner(
